...
<section class="showcase">
        <header> 
             <h2 class="logo "><img class="bruh" src="https://i.imgur.com/3HewRiE.png" width="200px"/></h2> 
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-around">
                    <div class="col-xl-6 col-lg-6 d-none d-lg-block mr-auto">
                        <picture>
                            <img class="img-fluid" src="https://freepngimg.com/thumb/anime/128202-anime-png-file-hd.png" alt="login to ">
                        </picture>
                    </div>
        ...
        <section id="redirect-timer" data-start="10" data-end="0" data-href="https://obito.ml/">
    <div class="inner">
        <p>Your account has been <strong>successfully created</strong>, check your <strong>mail</strong> for credentials, redirecting to Login Page <span id="counter"></span>.</p>
    </div>
</section>
    </div>    
